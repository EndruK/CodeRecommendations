...
class Dataset:
    ...
    def extract_statement_process(file_list, process_id, output_path, num_per_file=20000):
        ...
        for path in file_list:
            ...
            tuples = Dataset.extract_statements_file(path, limit=Dataset.STATEMENT_LIMIT)
    ...
    @staticmethod
    def extract_statements_file(source_path, limit=100):
        """
...
if __name__ == "__main__":
    ...
    corpus_path =     "/media/andre/E896A5A496A573AA/Corpora/AndreKarge_2018-09-12_JavaAST_JSON_without_features/Dataset"
    cut_result_path = "/media/andre/E896A5A496A573AA/Corpora/AndreKarge_2018-09-12_JavaAST_JSON_without_features/2018_12_14_split_ast_methods_statement_v2"
    preprocess_result_path = "/media/andre/E896A5A496A573AA/Corpora/AndreKarge_2018-09-12_JavaAST_JSON_without_features/csv_test"
    num_of_processes = 7
    ...
    ds.load_csv(csv_path=preprocess_result_path+"/dataset.csv")
    ds.partition_dataset(preprocess_result_path=preprocess_result_path)
    test = ds.partitions["training"].__getitem__(0)
    pass