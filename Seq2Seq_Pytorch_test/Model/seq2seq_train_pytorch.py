from Seq2Seq_Pytorch_test.Model.seq2seq_pytorch import TrainingHelper
...
def run_training(
    ...
    for epoch in range(1, epochs+1):
        ...
        for x_training, y_training, _ in training_batch_generator:
            ...
            training_batch_loss, training_batch_accuracy = training_helper.training_iteration(x_training, y_training)
            ...
            if global_step % validation_interval == 0:
                ...
                for x_validation, y_validation,_ in validation_batch_generator:
                    validation_batch_loss, \
                        validation_batch_accuracy = training_helper.valid_test_iteration(x_validation, y_validation)
    ...
    for x_testing, y_testing, _ in testing_batch_generator:
        testing_batch_loss, testing_batch_accuracy = training_helper.valid_test_iteration(x_testing, y_testing)
