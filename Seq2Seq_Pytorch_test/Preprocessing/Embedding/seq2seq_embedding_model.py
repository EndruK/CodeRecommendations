...
class Seq2SeqEmbeddingModel:
    def __init__(self,
        ...
        # TODO: ask to build or reuse

        # self.skip_tuples_validation = self.build_dataset(self.model.validation_samples)
